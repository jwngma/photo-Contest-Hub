...
class LiveDetailsPage extends StatefulWidget {
  ...
  const LiveDetailsPage({Key key, this.eventsModel}) : super(key: key);

  @override
  _LiveDetailsPageState createState() =>
      _LiveDetailsPageState(this.eventsModel);
}

class _LiveDetailsPageState extends State<LiveDetailsPage> {
  final EventModels eventModel;

  _LiveDetailsPageState(this.eventModel);
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                AllParticipantsModel
                                                  ...
                                                  likes: snapshots
                                                      ...
                                                      .data["likes"],
                                                  liked: likers_array
                                                          .contains(Constants.prefs.getString("uid"))
                                                      ? true
                                                      : false,
                                                );
                                                return Card(
